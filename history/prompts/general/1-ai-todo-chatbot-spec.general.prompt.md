...
- Agent uses OpenAI Agents SDK Runner + Cohere Compatibility API (base_url: https://api.cohere.ai/compatibility/v1, api_key: sjIDGeQcQXYFsOTr7czPRYpU0J5pC6gIzzd16xOG)
